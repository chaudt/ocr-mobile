...
const UploadImageRequest$json = const {
  ...
  '2': const [
    ...
    const {'1': 'fileNameWithoutExtension', '3': 2, '4': 1, '5': 9, '10': 'fileNameWithoutExtension'},
    const {'1': 'data', '3': 3, '4': 1, '5': 12, '10': 'data'},
  ],
};

/// Descriptor for `UploadImageRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List uploadImageRequestDescriptor = $convert.base64Decode('ChJVcGxvYWRJbWFnZVJlcXVlc3QSGgoIZmlsZU5hbWUYASABKAlSCGZpbGVOYW1lEjoKGGZpbGVOYW1lV2l0aG91dEV4dGVuc2lvbhgCIAEoCVIYZmlsZU5hbWVXaXRob3V0RXh0ZW5zaW9uEhIKBGRhdGEYAyABKAxSBGRhdGE=');
